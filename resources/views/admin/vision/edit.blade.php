                ...
                <div class="tpl-block">
                    ...
                    <div class="am-g">
                        <div class="tpl-form-body tpl-form-line">
                            <form class="am-form tpl-form-line-form" action="{{url('admin/vision/editStore')}}" method="post" enctype="">
                                {!! csrf_field() !!}
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <!-- 编辑器容器 -->
                                        <script id="container" name="content" type="text/plain" >@php echo html_entity_decode($vision->content) @endphp</script>
