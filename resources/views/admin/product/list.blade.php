                    ...
                    <div class="am-u-sm-12 am-u-md-6">
                        <div class="am-btn-toolbar">
                            <div class="am-btn-group am-btn-group-xs">
                                ...
                                <a href="{{url('admin/product/create')}}" type="button"
                            ...
                            <table class="am-table am-table-striped am-table-hover table-main">
                                ...
                                @foreach($data as $value)
                                    <tr>
                                        ...
                                        <td>{{$value->id}}</td>
                                        <td><a href="#">{{$value->prod_name}}</a></td>
                                        <td>{{$value->prod_cid}}</td>
                                        <td class="am-hide-sm-only">{{$value->updated_at}}</td>
                                        <td>
                                            <div class="am-btn-toolbar">
                                                <div class="am-btn-group am-btn-group-xs">
                                                    <a href="{{url('admin/product/edit',['id'=>$value->id])}}"
                                                       class="am-btn am-btn-default am-btn-xs am-text-secondary"><span
                                                                class="am-icon-pencil-square-o"></span> 编辑</a>
                                                    <a href="{{url('admin/product/del',['id'=>$value->id])}}"
